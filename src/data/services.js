/**
 * =======================================================================
 * SHREE BALAJI CONSTRUCTIONS - SERVICES DATA
 * =======================================================================
 * The 10 official construction, civil contracting, and engineering service offerings.
 */
...
export const servicesData = [
  {
    ...
    capabilities: [
      ...
      "Post-tensioned and conventional slab reinforcement",
      "Precision masonry, brickwork, and plastering",
      "Multi-story structural frame erection and QA testing"
    ],
    applications: [
      "Commercial Complexes & Office Centers",
      "Schools & Educational Institutions",
      "Residential Apartments & Independent Bungalows",
  ...
  },
  {
    ...
    capabilities: [
      ...
      "Pavement Quality Concrete (PQC) and heavy-duty concrete roads",
      "Asphalt bituminous road surfacing and lane marking",
      "Integrated stormwater side drains, culverts, and kerb stones"
    ],
    applications: [
      "Logistics Park Internal Circulation Corridors",
      "Factory Campus & Manufacturing Plant Roads",
      "Residential Colony Arterial Roads",
      "Heavy Vehicle Parking Aprons & Loading Yards"
    ]
  },
  {
    ...
    capabilities: [
      ...
      "Loading dock pits, ramps, and heavy vehicular aprons",
      "Waterproofed perimeter plinths and retaining walls",
      "Rapid-turnaround execution schedules"
    ],
    applications: [
      "E-Commerce & 3PL Logistics Centers",
      "Cold Storage & FMCG Distribution Warehouses",
      "Agricultural Produce & Commodity Warehouses",
      "Automotive Spare Parts Storage Hubs"
    ]
  },
  {
    ...
    capabilities: [
      ...
      "Effluent containment sumps and secondary containment bunds",
      "Overhead crane gantry civil foundations and bracket tie-ins",
      "Structural steel framing and insulated perimeter walling"
    ],
    applications: [
      "Manufacturing & Assembly Plants",
      "Automotive Ancillary Units",
      "Heavy Engineering & Metal Fabrication Workshops",
  ...
  },
  {
    ...
    capabilities: [
      ...
      "Rainwater harvesting pits, filter chambers, and recharge wells",
      "Heavy-duty cast iron / RCC drain gratings for traffic loading",
      "Precision slope grading using auto-levels and optical theodolites"
    ],
    applications: [
      "Industrial Park Stormwater Management",
      "Warehouse Campus Drainage Grids",
      "Commercial Complex Perimeter Drainage",
      "Highway & Access Road Runoff Systems"
    ]
  },
  {
    id: "waterproofing",
    ...
    capabilities: [
      ...
      "Underground and overhead RCC water tank food-grade waterproofing",
      "Expansion joint sealing with polyurethane (PU) sealants",
      "Wet area (bathrooms, pantries, utility) waterproofing"
    ],
    applications: [
      "Commercial Building Basements & Sub-structures",
      "Industrial Warehouse Roof Envelopes",
      "Residential Terraces & Balconies",
      "Fire Water Storage Tanks & Retention Sump Basins"
    ]
  },
  {
    id: "metal-roofing",
    ...
    capabilities: [
      ...
      "Roof insulation systems (glass wool / rockwool / bubble foil)",
      "Ridge ventilators, continuous turbo vents, and gutters",
      "Leak-proof flashing, downspouts, and perimeter trims"
    ],
    applications: [
      "Wide-Span Logistics Sheds & Warehouses",
      "Manufacturing Plant Rooftops",
      "Agricultural & Grain Storage Sheds",
      "Industrial Canopies & Loading Bay Overhangs"
    ]
  },
  {
    id: "tiling",
    ...
    capabilities: [
      ...
      "Anti-skid outdoor paver blocks and interlocking tiles",
      "Wall dado tiling in industrial canteens and sanitary blocks",
      "Precision laser leveling and epoxy grout jointing"
    ],
    applications: [
      "Commercial Lobbies & Corporate Workspaces",
      "School Corridors & Assembly Halls",
      "Industrial Canteens, Laboratories & Cleanrooms",
      "Outdoor Walkways & Vehicular Driveways"
    ]
  },
  {
    id: "maintenance",
    ...
    capabilities: [
      ...
      "Roof leak rectification, sheet replacement, and gutter repairs",
      "Drainage de-silting, pipe clearing, and chamber rebuilding",
      "Repainting, weatherproofing touch-ups, and perimeter wall repairs"
    ],
    applications: [
      "Annual Maintenance Contracts (AMC) for Industrial Parks",
      "Commercial Property Upkeep & Renovation",
      "Logistics Warehouse Preventive Maintenance",
      "School & Institutional Campus Refurbishment"
    ]
  },
  {
    ...
    applications: [
      "Complete Greenfield Industrial Plant Projects",
      "Turnkey Commercial Building Construction",
      "Integrated Warehouse & Logistics Compounds",
      "Comprehensive Civil Development Programs"
    ]
  }
];
